//This file is just an example of what is on the websocket file on the unity editor
//You can read this file to see what is in the unity editor websocket file
//What you see here is exactly what is on the unity editor.
// SO you can find bugs or errors between the integration of the unity editor and the agent
